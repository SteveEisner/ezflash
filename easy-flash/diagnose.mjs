...
export function diagnosePresentation(d={}){
 ...
 const responded=Number(d.bytesCaptured)>0||d.state==="partial"||d.state==="telemetry";
 ...
 if(responded)return {tone:"green",label:"Healthy",summary:"The supported controller responded normally and reported no explicit fault.",next:"",action:"Check another USB device"};
 return {tone:"yellow",label:"Unknown",summary:"The controller was unsupported, unreadable, or did not respond.",next:"",action:"Choose USB device again"};
}
