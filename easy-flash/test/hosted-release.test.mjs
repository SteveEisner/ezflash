...
const manifest=()=>({schemaVersion:2,provisional:true,variants:definitions.map(([id,printedModel,chip])=>({id,hardwareTested:false,target:{printedModel,hardwareFamily:id,chip},artifacts:[{kind:"complete-merged-image",transport:"usb",path:`releases/r-1/firmware/${id}-merged.bin`,offset:0,sizeBytes:3,sha256:"a".repeat(64),components:[]}]}))});
