...
The static site includes WLEDtubes firmware and Easy Flash source under the EUPL-1.2-or-later. The complete license is shipped as `LICENSE`. The generated release receipt records the exact SteveEisner/WLEDtubes source commit used for each candidate; the presence of a tracked pilot binary is not provenance by itself. Source: <https://github.com/SteveEisner/WLEDtubes>.
